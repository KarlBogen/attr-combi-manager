...
class KKDefaultHookPoints
{
    public function registerAll()
    {
        ...
        $hookPointManager->registerHookPoint([
            ...
            'file' => '/' . DIR_ADMIN . 'includes/modules/categories_view.php',
            'hash' => '3e93faae7d5d1af9ab367bc822f9fbe9',
            'line' => 661,
            'include' => '/' . DIR_ADMIN . 'includes/extra/hpm/categories_view/small_buttons/'
        ], ['2.0.6.0']);
        ...
        $hookPointManager->registerHookPoint([
            ...
            'hash' => '3e93faae7d5d1af9ab367bc822f9fbe9',
            'line' => 1001,
            'include' => '/' . DIR_ADMIN . 'includes/extra/hpm/categories_view/side_buttons/'
        ], ['2.0.6.0']);
        ...
        $hookPointManager->registerHookPoint([
            ...
            'module' => 'robinthehood/hook-point-manager',
            'file' => '/' . DIR_ADMIN . 'includes/modules/new_product.php',
            'hash' => '007e9af6ec2cfa8c384d914d4edcae22',
            'line' => 254,
            'include' => '/' . DIR_ADMIN . 'includes/extra/hpm/new_product/buttons/'
        ], ['2.0.6.0']);
