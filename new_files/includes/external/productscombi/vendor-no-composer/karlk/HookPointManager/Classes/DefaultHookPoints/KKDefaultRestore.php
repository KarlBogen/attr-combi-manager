...
class KKDefaultRestore
{
  ...
  protected function getSumoselectData($modifiedVersion)
  {
    ...
    $data =  array(
      'TPLFILE' => DIR_FS_CATALOG . 'templates/' . CURRENT_TEMPLATE . '/javascript/extra/sumoselect.js.php',
  ...
  protected function getDefaultData()
  {
    ...
    $data =  array(
      'TPLFILE' => DIR_FS_CATALOG . 'templates/' . CURRENT_TEMPLATE . '/javascript/extra/default.js.php',
      'SEARCHPATTERN' => $this->getSearchpatternPHP(),
      'REPLACESTRING' => '',
    );
    return $data;
  ...
  protected function getProductInfoData()
  {
    ...
    foreach ($tpls as $tpl) {
      $data[] =  array(
        'TPLFILE' => DIR_FS_CATALOG . 'templates/' . CURRENT_TEMPLATE . '/module/product_info/' . $tpl,
