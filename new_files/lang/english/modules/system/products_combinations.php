...
define('MODULE_PRODUCTS_COMBINATIONS_BUTTON_MODIFYTPL_CONFIRM', 'Do you really want to search and change the template files?');
...
define('MODULE_PRODUCTS_COMBINATIONS_BUTTON_RESTORETPL_CONFIRM', 'Do you really want to search through the template files and remove changes?');
