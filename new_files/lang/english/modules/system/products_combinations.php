...
define('MODULE_PRODUCTS_COMBINATIONS_BUTTON_DELETE_NOTABLE', 'Delete all module files,<br>save data tables!');
define('MODULE_PRODUCTS_COMBINATIONS_BUTTON_DELETE_NOTABLE_DESC', '<u>Note:</u><br>All module files will be deleted, file modifications removed, all database tables containing product combinations will be <b>not</b> deleted!<br><br>');
...
define('MODULE_PRODUCTS_COMBINATIONS_BUTTON_RESTORETPL_DESC', 'With this function, file modifications can be removed. The changed files<br>- /admin/includes/modules/categories_view.php<br>- /admin/includes/modules/new_product.php<br>are not reseted!<br><br>');
...
define('MODULE_PRODUCTS_COMBINATIONS_BOOTSTRAP_TITLE', 'Is a bootstrap4 template used with activated image zoom effect?');
...
define('MODULE_PRODUCTS_COMBINATIONS_DONTREMOVETABLE', '<b>Please note:</b> All created and saved product combinations will not be deleted!');
define('MODULE_PRODUCTS_COMBINATIONS_REMOVE', '<b>Please note:</b> All created and saved product combinations will be deleted!');
