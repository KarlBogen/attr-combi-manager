...
define('MODULE_PRODUCTS_COMBINATIONS_BUTTON_DELETE_NOTABLE', 'Moduldateien l&ouml;schen,<br>Datentabellen behalten!');
define('MODULE_PRODUCTS_COMBINATIONS_BUTTON_DELETE_NOTABLE_DESC', '<u>Hinweis:</u><br>Es werden alle Moduldateien gel&ouml;scht, Dateianpassungen wieder entfernt, alle Datenbanktabellen mit Produktkombinationen werden <b>nicht</b> gel&ouml;scht!<br><br>');
...
define('MODULE_PRODUCTS_COMBINATIONS_BUTTON_RESTORETPL_DESC', '<u>Hinweis:</u><br>Mit dieser Funktion k&ouml;nnen Dateianpassungen wieder entfernt werden. Die ver&auml;nderten Dateien<br>- /admin/includes/modules/categories_view.php<br>- /admin/includes/modules/new_product.php<br>werden nicht zur&uuml;ckgesetzt!<br><br>');
...
define('MODULE_PRODUCTS_COMBINATIONS_DONTREMOVETABLE', '<b>Bitte beachten:</b> Alle bisher erstellten und gespeicherten Produktkombinationen werden <b>nicht</b> gel&ouml;scht!');
define('MODULE_PRODUCTS_COMBINATIONS_REMOVE', '<b>Bitte beachten:</b> Alle bisher erstellten und gespeicherten Produktkombinationen werden gel&ouml;scht!');
