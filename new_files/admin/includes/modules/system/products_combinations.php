...
class products_combinations
{
  ...
  public function __construct()
  {
    ...
    $this->title = MODULE_PRODUCTS_COMBINATIONS_TEXT_TITLE . ' - Version: 1.0.23';
    $this->description = '';
  ...
  public function update()
  {
    ...
    if (is_dir(DIR_FS_EXTERNAL . 'productscombi')) {
      $dirs_and_files[] = $shop_path . 'vendor';
      $dirs_and_files[] = $shop_path . 'vendor-no-composer';
    }
    // Dateien löschen
  ...
  protected function removeAllFiles()
  {
    ...
    $dirs_and_files[] = $shop_path . 'includes/external/productscombi';
