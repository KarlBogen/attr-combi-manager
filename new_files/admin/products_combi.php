          ...
          <table class="tableCenter">
            <tr>
              <td class="boxCenter">
                ...
                <div class="pageHeading pdg2"><?php echo PROD_COMBI_HEADER_TITLE;
                                              if (isset($_POST['current_product_id'])) echo $ProductCombiAdmin->getCombiProductName($_POST['current_product_id'], $_SESSION['languages_id']) ?></div>
                <?php //hier gehts Los
                ?>
                <table class="tableCenter">
                  <tr>
